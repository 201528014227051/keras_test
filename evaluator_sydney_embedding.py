    ...
    def write_captions(self, dump_filename=None):
        ...
        for image_name in image_names:
            ...
            features = self.image_names_to_features[image_name]\
                                            ['image_features'][:]
            text = np.zeros((1, self.MAX_TOKEN_LENGTH))
            begin_token_id = self.word_to_id[self.BOS]
            text[0, 0] = begin_token_id
...
if __name__ == '__main__':
    ...
    #model_filename = '../trained_models/sydney/sydney_weights.499-1.10.hdf5'
    #model_filename = '../trained_models/sydney/vgg16/sydney_weights.498-3.97.hdf5'
    #model_filename = '../trained_models/sydney/vgg16_20/sydney_weights.131-3.92.hdf5'
    #model_filename = '../trained_models/sydney/sydney_weights.499-0.92.hdf5'
    #model_filename = '../trained_models/sydney/vgg16_embedding/sydney_weights.81-0.20.hdf5'
    #model_filename = '../trained_models/sydney/vgg16_embedding/sydney_weights.190-0.14.hdf5'
    #model_filename = '../trained_models/sydney/vgg16_embedding_200/sydney_weights.499-0.16.hdf5'
    #model_filename = '../trained_models/flicker8/flicker8_200/sydney_weights.433-1.00.hdf5'
    model_filename = '../trained_models/flicker8/flicker8_50/flicker8_weights.131-1.02.hdf5'
